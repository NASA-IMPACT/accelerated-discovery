...
{_QUESTION_PLACEHOLDER}{_PROMPT_END_PLACEHOLDER}
"""
...
if __name__ == "__main__":
    ...
    filename = "/home/radu/git/fm-factual/data/data_books.jsonl"
    questions = read_data(filename)
    responses = generate_data(model=model, questions=questions)

    output_filename = "/home/radu/git/fm-factual/data/books-unlabeled.jsonl"
