...
class Section(BaseModel):
    ...
    subsections: Optional[list[SubSection]] = Field(
        ...,
        title="List of optional subsections pertaining to the section",
    )
...
class ParsedPaper(PaperDataItem):
    ...
    figures: Optional[list] = Field(
        default=None,
        title="List of figures present in the paper",
    )
    tables: Optional[list] = Field(
        default=None,
        title="List of tables present in the paper",
    )
    section_titles: Optional[list] = Field(default=None, title="List of section titles")
    sections: Optional[List[Section]] = Field(
        default=None,
        title="Sections present in the paper",
    )
