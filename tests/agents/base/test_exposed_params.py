...
class TestExposedParamFunctionality:
    ...
    def test_get_exposed_params_without_values(self, mock_instructor_client):
    ...
    def test_get_exposed_params_with_values(self, mock_instructor_client):
    ...
    def test_exposed_param_auto_description_from_docstring(self, mock_instructor_client):
    ...
    def test_exposed_param_editable_detection(self, mock_instructor_client):
    ...
    def test_exposed_param_setter_functionality(self, mock_instructor_client):
    ...
    def test_exposed_param_extra_metadata(self, mock_instructor_client):
    ...
    def test_exposed_param_type_inference(self, mock_instructor_client):
    ...
    def test_regular_properties_not_exposed(self, mock_instructor_client):
    ...
    def test_exposed_param_with_complex_types(self, mock_instructor_client):
    ...
    def test_multiple_agents_independent_exposed_params(self, mock_instructor_client):
    ...
    def test_exposed_param_type_validation(self, mock_instructor_client):
