...
BASE_PAPER_DATA = dict(
    ...
    abstract=None, venue=None, publication_venue=None, year=None,
    reference_count=None, citation_count=None, influential_citation_count=None,
    is_open_access=False, open_access_pdf={'url': '', 'status': None, 'license': None},
    fields_of_study=None, s2_fields_of_study=None, publication_types=None,
    publication_date=None, journal=None, citation_styles=None,
    authors=None, citations=None, references=None, embedding=None, tldr=None,
...
def dummy_search_results():
    ...
    return [SearchResultItem(url=AnyUrl('http://arxiv.org/abs/2504.06136v1'), 
                             title='QGen Studio: An Adaptive Question-Answer Generation, Training and Evaluation Platform', 
                             query='test query', 
...
def dummy_parsed_paper():
    ...
    return [ParsedPaper(**BASE_PAPER_DATA, figures=None, tables=None,
...
async def test_fetch_paper_items(agent, dummy_search_results, dummy_paper_item):
    ...
    agent.semantic_search_tool.fetch_paper_by_external_id = AsyncMock(return_value=dummy_paper_item)
...
async def test_fetch_parsed_papers(agent, dummy_parsed_paper, dummy_paper_item):
    ...
    parsed_papers = await agent._fetch_parsed_papers(dummy_parsed_pdfs, dummy_paper_item)
