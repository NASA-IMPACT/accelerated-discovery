...
class TestSearchPipelineConfig:
    ...
    def test_default_config(self):
        ...
        assert config.scraping_mode == SearchPipelineScrapingMode.ALWAYS_ON
    ...
    def test_custom_config(self):
        config = SearchPipelineConfig(
            ...
            scraping_mode=SearchPipelineScrapingMode.ALWAYS_OFF,
            scraping_timeout=60,
        ...
        assert config.scraping_mode == SearchPipelineScrapingMode.ALWAYS_OFF
...
class TestSearchPipeline:
    ...
    def test_init_with_defaults(self, sample_search_results):
        ...
        with (
            patch.object(
                SearchPipeline,
                "_default_research_article_resolver",
                new_callable=PropertyMock,
            ) as mock_resolver_prop,
            patch.object(
                SearchPipeline,
                "_default_scraper",
                new_callable=PropertyMock,
            ) as mock_scraper_prop,
        ):
